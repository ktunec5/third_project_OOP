...
second_full_time_employee = FullTimeEmployee('Магнус', 'Федоров', 'м', 10000)
second_part_time_employee = PartTimeEmployee('Глен', 'Михельсон', 'м')
...
print(second_full_time_employee._employee_id)
